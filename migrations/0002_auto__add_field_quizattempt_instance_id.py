...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizAttempt.instance_id'
        db.add_column('mquiz_quizattempt', 'instance_id',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizAttempt.instance_id'
        db.delete_column('mquiz_quizattempt', 'instance_id')
